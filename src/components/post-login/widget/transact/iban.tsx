...
import type { IbanTransferWidget } from "@/lib/useWebSocket";
import { useWebSocketContext } from "@/lib/WebSocketProvider";

const IbanWidgetComponent = ({
	widget,
	messageId,
}: {
	widget: IbanTransferWidget;
	messageId: string;
}) => {
						...
						<div className="flex items-start justify-between mb-4 pb-4 border-b border-gray-600">
							<div className="flex items-center gap-3">
								...
								<div>
									...
									<p className="text-sm text-gray-300">{item.iban}</p>
								</div>
							</div>

							{/* Change Contact (Iban) Button */}
...
export default IbanWidgetComponent;
