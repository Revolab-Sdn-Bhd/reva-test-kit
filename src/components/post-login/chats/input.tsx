...
const ChatInputSection = () => {
  const { isConnected, sendMessage, isTranscribing } = useWebSocketContext();
    ...
    <div className="p-6 border-t border-gray-700">
      ...
      : <div className="flex gap-2">
          ...
          <button
            ...
            disabled={!isConnected}
            className="px-4 font-medium text-white bg-purple-600 rounded hover:bg-purple-700 disabled:bg-gray-700 disabled:text-gray-500 disabled:cursor-not-allowed"
