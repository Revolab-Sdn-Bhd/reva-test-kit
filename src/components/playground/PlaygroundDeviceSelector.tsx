...
export const PlaygroundDeviceSelector = ({
	...
	return (
		<div>
			<button
				className="flex items-center gap-2 px-2 py-1 text-gray-300 bg-gray-900 border border-gray-800 rounded-sm hover:bg-gray-800"
				onClick={(e) => {
			...
			<div
				className="absolute z-10 text-gray-300 bg-gray-800 border border-gray-800 rounded-sm right-4 top-12"
				style={{
