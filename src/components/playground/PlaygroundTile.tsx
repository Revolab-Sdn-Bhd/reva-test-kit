...
export const PlaygroundTile: React.FC<PlaygroundTileProps> = ({
	...
	return (
		...
		>
			{title && (
				<div
					className="flex items-center justify-center py-2 text-xs tracking-wider uppercase border-b border-b-gray-800"
					style={{
...
export const PlaygroundTabbedTile: React.FC<PlaygroundTabbedTileProps> = ({
	...
	return (
		...
		>
			<div
				className="flex items-center justify-start text-xs tracking-wider uppercase border-b border-b-gray-800"
				style={{
					height: `${titleHeight}px`,
				}}
			>
