...
const msgSchema = z.object({
  escalated_voice: z.object({ escalated: z.boolean(), wa_link: z.string().optional(), chat_id: z.string().optional(), session_id: z.string().optional() }),
});
...
export function useEscalatedChannel(config: ChannelConfig = {}) {
  const [data, setData] = useState<EscalationData>({ chatId: null, sessionId: null, wsLink: null });
